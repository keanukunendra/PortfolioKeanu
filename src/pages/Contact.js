    ...
    <div>
      <Navbar />
        ...
        <div className="first-wrap">
            ...
            <div className="wrap2" >
                <div className="title"> 
                    <p className="detail">Connect with us:<br />For support or any questions <br /> Email us at <br /> <a className="link" href="https://binar.co.id/">krama-team@gmail.com</a> </p>
                </div>
                <div >
        ...
        <div className="sec-wrap">
            <div className="wrap-form">
                ...
                <form className="contact-form" action="">
                    <div><input name="name" className="name" type="text" placeholder="Name" /></div>
                    <div><input name="email" className="name" type="text" placeholder="You email address" /></div>
                    <div><textarea name="message" name="" id="message" cols="50" rows="10" placeholder="Message"></textarea></div>
